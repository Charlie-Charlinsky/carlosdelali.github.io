...
try {
    ...
    Assert-Foundation ($resolved.Count -eq 8 -and $resolved[3].TargetKey -ceq 'copyright:main' -and $resolved[3].Outputs -contains 'content/copyright/es.html') 'fixed pages, Copyright, and all registry families resolve'
